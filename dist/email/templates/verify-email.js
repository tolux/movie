...
exports.generateVerifyEmail = void 0;
const generateVerifyEmail = (otp) => `<!DOCTYPE html>
										...
										<tbody>
											<tr>
														...
														<tr>
															<td class="pad"
																...
																<div
																	...
																	<p class="heading_msg_2" style="margin: 0; width: 220px;"><strong>Verify your Email Address</strong></p>
																</div>
															</td>
														</tr>
													</table>
												...
												<td class="column column-2"
													style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-top: 0px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;"
													width="50%">
													<table border="0" cellpadding="0" cellspacing="0"
														class="image_block block-1" role="presentation"
														style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"
														...
														<tr>
															<td class="pad"
																...
																<div align="right" class="alignment"
																	style="line-height:10px"><img
																		src="https://res.cloudinary.com/dicdmfd61/image/upload/v1682421105/Email-assets/Maill_wmm96z.png"
														...
														<tr>
															<td class="pad">
																<div
																	...
																	<p style="margin: 0;">Thank you and welcome to Smatta family!</p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad">
																<div
																	...
																	<p style="margin: 0; margin-bottom: 3px; padding-bottom: 15px;">To begin, activate your account by confirming your email using the code below</p>
													...
													<table border="0" cellpadding="10" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0; margin-bottom: 2px;">Your verification code</p>
																	<p style="margin: 0;">The code is valid for 5 minutes</p>
																</div>
															</td>
														</tr>
													</table>
													...
													<table border="0" cellpadding="10" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0; margin-bottom: 2px;">If you did not create an account, no further action is required.
																	</p>
																	<p style="margin: 0;padding-top: 15px;">For customer service inquiries, please contact customer support.</p>
																	<p style="margin: 0; padding-top: 15px;">Kind regards,</p>
																	<p style="margin: 0;">Smattaglobal Team</p>
																</div>
															</td>
														</tr>
													</table>
