...
exports.generateOtpMail = void 0;
const generateOtpMail = (otp) => `<!DOCTYPE html>
...
<body style="background-color: #ffffff; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none; width: 100%;">
														...
														<tr>
															<td class="pad"
																...
																<div
																	...
																	<p class="heading_msg_2" style="margin: 0; width: 150px;"><strong>Check your mail!</strong></p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad"
																...
																<div align="right" class="alignment"
																	style="line-height:10px"><img
																		src="https://res.cloudinary.com/dicdmfd61/image/upload/v1682421105/Email-assets/Otp_n8rakl.png"
																		style="display: block; height: auto; border: 0; width: 233px; max-width: 100%;"
																		alt="Otp"
																		width="203" /></div>
															</td>
														</tr>
														...
														<tr>
															<td class="pad">
																<div
																	...
																	<p style="margin: 0;">Please enter the 6-digit OTP code that was sent to your email. The code is valid for 5 minutes</p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad">
																<div
																	...
																	<p style="margin: 0; margin-bottom: 3px;">Verification code</p>
													...
													<table border="0" cellpadding="10" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0; margin-bottom: 2px;">Please do not share this code with anyone.</p>
																</div>
															</td>
														</tr>
													</table>
...
exports.generateOtpMail = generateOtpMail;
//# sourceMappingURL=otp-request.js.map