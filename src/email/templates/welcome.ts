export const generateWelcomeMail = (name: string) => `<!DOCTYPE html>
...
<!-- TODO <a> links for footer text should be links to live web pages -->
												...
												<td class="column column-1"
														...
														<tr>
															<td class="pad">
																<div
																	...
																	<p class="header_message_1" style="margin: 0;">Thanks for joining us!</p>
																</div>
															</td>
														</tr>
													</table>
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad"
																...
																<div
																	style="color:#ffffff;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:30px;font-weight:700;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:34.8px;">
																	<p class="heading_msg_2" style="margin: 0;"><strong>WELCOME
																			ABOARD.</strong></p>
																</div>
															</td>
														</tr>
													...
													<table border="0" cellpadding="10" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#000000;width:135px;background-color: #AAE7C6;border-radius:5px;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0;
																	text-align: center;">We'll be in touch.</p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad"
																...
																<div align="right" class="alignment"
																	style="line-height:10px"><img
																		src="https://res.cloudinary.com/dicdmfd61/image/upload/v1682421107/Email-assets/Megaphone_hm118z.png"
																		style="display: block; height: auto; border: 0; width: 245px; max-width: 100%;"
																		alt="Megaphone"
																		title="Megaphone"
																		width="230" height="auto"/></div>
															</td>
														</tr>
													</table>
												</td>
														...
														<tr>
															<td class="pad">
																<div
																	...
																	<p style="margin: 0; text-transform: capitalize;">Hi <strong class="user_name">${name},</strong></p>
																</div>
															</td>
														</tr>
													</table>
													...
													<table border="0" cellpadding="10" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0;">Thanks for signing up to keep
																		in touch with <span
																			style="background-color: transparent; font-family: inherit;">SMATTA.
																			From now on, you'll get regular </span><span
																			style="background-color: transparent; font-family: inherit;">updates
																			on our new products, investment </span><span
																			style="background-color: transparent; font-family: inherit;">opportunities,
																			industry related news, articles </span><span
																			style="background-color: transparent; font-family: inherit;">and
																			so much more.</span></p>
																</div>
															</td>
														</tr>
													...
													<table border="0" cellpadding="10" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0; margin-bottom: 3px;">In the
																		meantime, seat back and take a sip.</p>
																	<p style="margin: 0;"><span
																			style="background-color: transparent; font-family: inherit;">Here's
																			to the start of a healthy financial.</span>
																	</p>
																</div>
															</td>
														</tr>
													...
													<table border="0" cellpadding="10" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0; margin-bottom: 2px;">P.S You
																		can also get to know us better on,</p>
																	<p style="margin: 0;">Linkedin, Facebook, and
																		Instagram, too.</p>
																</div>
															</td>
														</tr>
													...
													<table border="0" cellpadding="10" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0; margin-bottom: 2px;">Cheers,
																	</p>
																	<p style="margin: 0;">Smattaglobal</p>
																</div>
															</td>
														</tr>
													</table>
